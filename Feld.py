        ...
        for number in range(9):
            for item_row in range(9):
                for item_col in range(9):
                    ...
                    if new_Sudoku.set(self, chr(item_row + 97), chr(item_col + 49), number + 1) == "Conflicted value {0}!\n".format(number + 1):
                        new_Sudoku.set(self, chr(item_row + 97), chr(item_col + 49), item)
                    else:
                        _value = number + 1
